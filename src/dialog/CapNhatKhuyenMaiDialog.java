...
public class CapNhatKhuyenMaiDialog extends JDialog {
    ...
    public CapNhatKhuyenMaiDialog(KhuyenMai khuyenMai) {
    ...
    private void initComponents() {
        ...
        // Header
        lblHeader = new JLabel("Cập nhật khuyến mãi");
        ...
        txtMaKM.setEditable(false); // Mã khuyến mãi không thể chỉnh sửa
    ...
    private void capNhatAction() {
        if (valid()) {
            ...
            khuyenMaiDAO.capNhatKhuyenMai(khuyenMai);

            JOptionPane.showMessageDialog(this, "Khuyến mãi đã được cập nhật thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        }
    }
    ...
    private void loadData() {
        if (khuyenMai != null) {
            ...
            txtChietKhau.setText(String.valueOf(khuyenMai.getChietKhau()));
            cbTrangThai.setSelectedItem(khuyenMai.isTrangThai() ? "Hoạt động" : "Hết hạn");
        }
    }
}
